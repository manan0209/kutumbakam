                      ...
                      {selectedTemplate && (
                        <div className="border-t pt-6 mt-6">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                              <Label htmlFor="template-location">
                                Location *
                              </Label>
                              <Select
                                value={location}
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-gray-500">
                          Upload images of the affected area or relief efforts
                          (JPEG, PNG)
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 gap-4 mt-2">
                          {newsClippings.map((news, index) => (
                            <div
                              key={index}
                              className="flex items-start border rounded p-3 bg-gray-50"
                            >
                          ...
                          <div className="border rounded p-3 space-y-3">
                            ...
                            <div>
                              <Label htmlFor="news-url" className="text-sm">
                                URL (Optional)
                              </Label>
                              <Input
                                id="news-url"
                        ...
                        <p className="text-xs text-gray-500">
                          Add relevant news articles about the disaster
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-t pt-6 mt-6 flex justify-end gap-3">
                    ...
                    <Button
                      ...
                      disabled={
                        ...
                        !title ||
                        !description ||
                        (location === "custom" ? !customLocation : !location)
                      }
                    >
                      {loading
                        ? "Creating Portal..."
