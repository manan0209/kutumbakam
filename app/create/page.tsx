    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">Create a Disaster Relief Portal</h1>
          <p className="text-gray-600 mb-8">
            Set up a coordination hub for disaster relief efforts. This portal will help organize resources, 
            volunteers, and information in one place.
          </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg border">
              ...
              <div className="space-y-2">
                ...
                <Select value={urgency} onValueChange={(value) => setUrgency(value as "low" | "medium" | "high")}>
                  ...
                  <SelectContent>
                    <SelectItem value="low">Low - Ongoing situation, not immediately life-threatening</SelectItem>
                    <SelectItem value="medium">Medium - Serious situation requiring timely assistance</SelectItem>
                    <SelectItem value="high">High - Critical emergency requiring immediate action</SelectItem>
                  </SelectContent>
                </Select>
              </div>
