...
export default function RequestAssistancePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Thank you for your contribution! Your assistance has been recorded.")
      ...
      setError(err.message || "Failed to record your contribution")
    } finally {
      setLoading(false)
    }
  }
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {!user ? (
            <div className="text-center p-6 bg-gray-50 rounded-lg border mb-6">
              <p className="text-gray-600 mb-4">You need to be logged in to contribute resources.</p>
              <Button asChild>
                <a href={`/login?redirect=/request-assistance${portalId ? `?portalId=${portalId}` : ''}`}>Log In</a>
              </Button>
            </div>
          ) : loadingPortal ? (
                  ...
                  {selectedResource && (
                    <>
                      <div className="p-4 bg-gray-50 rounded-lg">
                        <h3 className="font-medium mb-2">{selectedResource.title}</h3>
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        <p className="text-sm text-gray-500">
                          Maximum needed: {selectedResource.quantity} {selectedResource.unit || "units"}
                        </p>
                      </div>
